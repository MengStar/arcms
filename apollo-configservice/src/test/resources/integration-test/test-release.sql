...
INSERT INTO Subject (AppId, Name, OwnerName, OwnerEmail) VALUES ('somePublicAppId','somePublicAppName','someOwnerName','someOwnerName@ctrip.com');
...
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('someAppId', 'application', false);
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('someAppId', 'someNamespace', true);
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('someAppId', 'someNamespace.xml', false);
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('someAppId', 'anotherNamespace', false);
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('somePublicAppId', 'application', false);
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('somePublicAppId', 'somePublicNamespace', true);
INSERT INTO SubjectParty (AppId, Name, IsPublic) VALUES ('somePublicAppId', 'anotherNamespace', true);

INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('someAppId', 'default', 'application');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('someAppId', 'default', 'someNamespace.xml');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('someAppId', 'default', 'anotherNamespace');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('someAppId', 'someCluster', 'someNamespace');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('somePublicAppId', 'default', 'application');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('somePublicAppId', 'someDC', 'somePublicNamespace');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('someAppId', 'default', 'somePublicNamespace');
INSERT INTO Party (AppId, ClusterName, NamespaceName) VALUES ('somePublicAppId', 'default', 'anotherNamespace');

INSERT INTO Publish (id, ReleaseKey, Name, Comment, AppId, ClusterName, NamespaceName, Configurations)

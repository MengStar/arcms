...
public class ConfigFileController implements ReleaseMessageListener {
    ...
    /**
     * @api {GET} /configfiles/{appId}/{clusterName}/{namespace:.+} queryConfigAsProperties
     * @apiGroup ConfigServer
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName
     * @apiParam {String} dataCenter
    ...
    /**
     * @api {GET} /json/{appId}/{clusterName}/{namespace:.+} queryConfigAsJson
     * @apiGroup ConfigServer
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName

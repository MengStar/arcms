...
public class InstanceConfigController {
    ...
    /**
     * @api {GET} /instances/by-release getByRelease
     * @apiGroup AdminInstance
     * @apiParam {String} releaseId
    ...
    /**
     * @api {GET} /instances/by-namespace-and-releases-not-in  getByReleasesNotIn
     * @apiGroup AdminInstance
    ...
    /**
     * @api {GET} /instances/by-namespace getInstancesByNamespace
     * @apiGroup AdminInstance
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName
    ...
    /**
     * @api {GET} /instances//by-namespace/count getInstancesCountByNamespace
     * @apiGroup AdminInstance
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName

...
public class NamespaceBranchController {
    ...
    /**
     * @api {POST} /apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/branches createBranch
     * @apiGroup AdminBranch
    ...
    /**
     * @api {GET} /apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/branches/{branchName}/rules findBranchGrayRules
     * @apiGroup AdminBranch
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName
    ...
    /**
     * @api {PUT} /apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/branches/{branchName}/rules updateBranchGrayRules
     * @apiGroup AdminBranch
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName
     * @apiParam {String} branchName
     * @apiParam {GrayReleaseRuleDTO} newRuleDto
     */
    @Transactional
    ...
    /**
     * @api {DELETE} /apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/branches/{branchName}  deleteBranch
     * @apiGroup AdminBranch
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName
    ...
    /**
     * @api {GET} /apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/branches loadNamespaceBranch
     * @apiGroup AdminBranch
     * @apiParam {String} appId
     * @apiParam {String} clusterName
     * @apiParam {String} namespaceName

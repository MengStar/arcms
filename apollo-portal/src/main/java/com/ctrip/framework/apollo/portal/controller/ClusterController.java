...
public class ClusterController {
    ...
    /**
     * @api {post} /apps/{appId}/envs/{env}/clusters createCluster
     * @apiGroup cluster
     * @apiParam {String} appId
     * @apiParam {String} env
     * @apiParam {ClusterDTO} cluster
     */
    ...
    /**
     * @api {delete} /apps/{appId}/envs/{env}/clusters/{clusterName:.+} deleteCluster
     * @apiGroup cluster
     * @apiParam {String} appId
     * @apiParam {String} env
    ...
    /**
     * @api {delete} /apps/{appId}/envs/{env}/clusters/{clusterName:.+}} loadCluster
     * @apiGroup cluster
     * @apiParam {String} appId
     * @apiParam {String} env
     * @apiParam {String} clusterName

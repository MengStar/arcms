...
public class ReleaseController {
    ...
    /**
     * @api {POST} /apps/{appId}/envs/{env}/clusters/{clusterName}/namespaces/{namespaceName}/releases createRelease
     * @apiGroup Release
    ...
    /**
     * @api {POST} /apps/{appId}/envs/{env}/clusters/{clusterName}/namespaces/{namespaceName}/branches/{branchName}/releases createGrayRelease
     * @apiGroup Release
     * @apiParam {String} appId
     * @apiParam {String} env
     * @apiParam {String} clusterName
    ...
    /**
     * @api {GET} /apps/{appId}/envs/{env}/clusters/{clusterName}/namespaces/{namespaceName}/releases/all findAllReleases
     * @apiGroup Release
     * @apiParam {String} appId
     * @apiParam {String} env
     * @apiParam {String} clusterName
    ...
    /**
     * @api {GET} /apps/{appId}/envs/{env}/clusters/{clusterName}/namespaces/{namespaceName}/releases/active findActiveReleases
     * @apiGroup Release
     * @apiParam {String} appId
     * @apiParam {String} env
     * @apiParam {String} clusterName
    ...
    /**
     * @api {GET} /envs/{env}/releases/compare compareRelease
     * @apiGroup Release
     * @apiParam {long} baseReleaseId
     * @apiParam {String} env
     * @apiParam {long} toCompareReleaseId
     */
    ...
    /**
     * @api {PUT} /envs/{env}/releases/{releaseId}/rollback rollback
     * @apiGroup Release
